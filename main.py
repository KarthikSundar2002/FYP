...
from model.resnextv2 import ReXNetV2
from model.resnextv1 import ReXNetV1
...
def get_args_parser():
    ...
    parser.add_argument('--data_set', default='rfmid', choices=['EyePacs','messidor1', 'messidor2','rfmid','apots','rsna','MICCAI'],
...
def main(args):
    ...
    if os.path.exists('rexnet_3.0.pth'):
